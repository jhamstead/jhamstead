 ...
 */
metadata {
	definition (name: "Z-Wave Repeater", namespace: "jhamstead", author: "jhamstead") {
...
def zwaveEvent(physicalgraph.zwave.commands.manufacturerspecificv2.ManufacturerSpecificReport cmd) {
    ...
    Map myMap = [name: "status", value: 'online', descriptionText: "$device.displayName is online", isStateChange: true]
