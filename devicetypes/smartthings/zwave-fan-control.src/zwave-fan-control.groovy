 ...
 */
metadata {
	definition (name: "Z-Wave Fan Control", namespace: "smartthings", author: "jhamstead") {
	...
	tiles (scale:2) {
		...
		main(["switch"])
		details(["switch", "fanMode1", "fanMode2", "fanMode3", "indicator", "levelSliderControl", "refresh"])
	}
	preferences {
